...
private static final Logger logger = LoggerFactory.getLogger(TranslationService.class);
    ...
    public String translateTextUsingPython(String text, String srcLang, String tgtLang) throws IOException {
        ...
        ProcessBuilder pb = new ProcessBuilder("python", "C:\\Users\\sathvika.kundarapu\\translation\\translate-dynamic-new\\translate-dynamic-new\\src\\main\\python\\translate.py", text, srcLang, tgtLang);
